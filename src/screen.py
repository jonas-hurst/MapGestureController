...
class Screen:
    def __init__(self, screen_id: int, upper_left_corner: Point3D, lower_right_corner: Point3D, px_width: int, px_height: int):
        """
        ...
        self.screen_plain = Plane3D.from_vectors(self.__upper_left_corner.get_pointvector(),
                                                 Vector3D.from_points(self.__upper_left_corner, lower_right_corner),
                                                 Vector3D(0, -1, 0)  # Third vector just points upwards
                                                 )

        self.__min_x = min((upper_left_corner.x, lower_right_corner.x))
        self.__max_x = max((upper_left_corner.x, lower_right_corner.x))
        self.__min_y = min((upper_left_corner.y, lower_right_corner.y))
        self.__max_y = max((upper_left_corner.y, lower_right_corner.y))
        self.__min_z = min((upper_left_corner.z, lower_right_corner.z))
        self.__max_z = max((upper_left_corner.z, lower_right_corner.z))
